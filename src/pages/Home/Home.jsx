...
import bannerImg from '../../assets/banner.jpg'; // La foto del camión de Coca-Cola
import logoImg from '../../assets/logo.png';     // El logo circular
  ...
  return (
    <div className={styles.homeContainer}>
      ...
      <header 
        ...
        style={{ 
           // Oscurecemos un poco más el fondo para que las letras blancas resalten sobre el camión rojo
